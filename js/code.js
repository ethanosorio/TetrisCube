...
var objects = [];   //polycube container
...
//initialize visual graphics
function setupGraphics(){    
    //set the scene
    scene = new THREE.Scene();
    //set the camera
    camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 3.5, 100);
    ...
    generateShapes();   //uses function from polycubes.js to create each shape
